...
<form id="form1">
  <DIV>
  <div align="center">
   <span style="font-size: 40px;color: white;font-weight: bold;">电影票订票网站管理后台
   </span>
  </div>  
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%">
        <TBODY>
          <TR>
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <A 
      href="method!loginout" target=_top><IMG 
      src="images/Top.files/nav_changePassword.gif" align=absMiddle border=0>退出系统</A> 
      <A href="method!changepwd" 
      target=mainFrame><IMG src="images/Top.files/nav_resetPassword.gif" 
      align=absMiddle border=0>修改密码</A> <IMG 
      src="images/Top.files/menu_seprator.gif" align=absMiddle> <SPAN 
